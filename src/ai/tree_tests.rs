...
fn test_rollback() {
    ...
    let node_2 =
        GameNode::new(None, State::new(players.clone()), Some(2), Some(3));
    let node_3 =
        GameNode::new(None, State::new(players.clone()), Some(2), Some(5));
    ...
    let node_5 =
        GameNode::new(None, State::new(players.clone()), Some(2), Some(2));
    let node_6 =
        GameNode::new(None, State::new(players.clone()), Some(2), Some(9));
